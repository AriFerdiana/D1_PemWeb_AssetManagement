@push('styles')
    ...
    <style>
        /* Mengatur tinggi peta dalam card */
...
<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            {{ __('Daftar Ruangan & Laboratorium') }}
        </h2>
    </x-slot>
                            ...
                            <script>
                                document.addEventListener('DOMContentLoaded', function() {
                                    ...
                                    var map{{ $room->id }} = L.map('map-{{ $room->id }}', {
                                        ...
                                        zoom: 16,
                                        zoomControl: false, // Hilangkan kontrol zoom biar rapi di card kecil
                                        dragging: false,    // Matikan geser biar user gak pusing scroll halaman
