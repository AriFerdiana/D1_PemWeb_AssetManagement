    ...
    <div x-data="{ showImportModal: false, fileName: '' }" class="space-y-6">
        ...
        <div class="bg-white p-4 rounded-xl shadow-sm border border-gray-100">
            <form method="GET" action="{{ route('admin.assets.index') }}" class="flex flex-col md:flex-row gap-4 items-center">
                ...
                {{-- [PERBAIKAN: DROPDOWN JUMLAH BARIS DITAMBAHKAN DI SINI] --}}
                <div class="w-full md:w-auto">
                    <select name="per_page" onchange="this.form.submit()" class="w-full md:w-24 rounded-lg border-gray-300 text-sm focus:ring-navy-500 focus:border-navy-500 cursor-pointer text-center font-bold bg-gray-50" title="Tampilkan per halaman">
